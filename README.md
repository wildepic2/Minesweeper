...
3. Kurze Beschreibung der Idee (2-5 Sätze):
...
5. Beschreibung des 2D-Arrays (Datentyp, Größe, Bedeutung der Werte):


6. Steuerung (welche Tasten/Mausaktionen was machen):
...
7. Verwendeter String und 1D-Array (kurz benennen):
Das 1D-Array wurde benutzt für die Speicherung von den Flagen.

8. Liste der eigenen Funktionen:
